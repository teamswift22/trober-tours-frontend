  ...
  return (
    <div className="grid grid-cols-2">
      <div>
        ...
        >
          {({ isSubmitting }) => (
            <Form className="space-y-6 mt-10 w-5/6">
              <div>
                <label
                  htmlFor="tourName"
              ...
              <div className="flex justify-end mt-10">
                <button className="bg-[#FA7454] hover:bg-orange-600 text-white font-normal py-3 px-3 rounded-lg w-1/3">
                  Set Destination
                </button>
              </div>
            </Form>
        ...
        <div className="mt-10 bg-white rounded-lg w-5/6 p-4">
          <h1>Added Stops</h1>
